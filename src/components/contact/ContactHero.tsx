  ...
  return (
    <>
      <style>{`
        ...
        .contact-fade-up { animation: fadeUp 0.7s ease both; }
        .contact-hero-title { font-size: 60px; }
        @media (max-width: 768px) { .contact-hero-title { font-size: 44px !important; } }
        @media (max-width: 480px) { .contact-hero-title { font-size: 32px !important; } }
      `}</style>
      ...
      <section style={{
        ...
        <div className="contact-fade-up" style={{ position: 'relative', textAlign: 'center', padding: '0 24px' }}>
          <div style={{
          ...
          <p style={{ marginTop: '18px', fontSize: '16px', color: 'rgba(255,255,255,0.45)', fontFamily: 'Arial, sans-serif' }}>
            We'd love to hear from you. Come train with us.
          </p>
        </div>
      </section>
    </>

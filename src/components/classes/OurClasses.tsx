  ...
  return (
    <>
      <style>{`
        ...
        @media (max-width: 900px) { .classes-grid { grid-template-columns: repeat(2, 1fr) !important; } }
        @media (max-width: 600px) { .classes-grid { grid-template-columns: 1fr !important; } }
      `}</style>
      ...
      <section style={{ background: '#0d0d0d', padding: '96px 24px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <p style={{
            ...
            Three programs — Wushu, Sanda and Fitness
          </p>
          ...
          <div className="classes-grid">
            ...
            <div className="class-card" style={{
              ...
              <div style={{ fontSize: '11px', fontWeight: 700, letterSpacing: '0.2em', color: '#E74C3C', fontFamily: 'Arial, sans-serif', marginBottom: '10px' }}>COMBAT SPORTS</div>
              <h3 style={{ fontSize: '28px', fontWeight: 800, color: '#fff', fontFamily: 'Arial, sans-serif', margin: '0 0 16px' }}>Sanda</h3>
              <p style={{ fontSize: '14px', lineHeight: 1.8, color: 'rgba(255,255,255,0.5)', fontFamily: 'Arial, sans-serif', marginBottom: '28px' }}>
                A dynamic Chinese combat sport combining striking, kicking and takedowns. Our standalone Sanda program is open to all levels focused on real fighting skills and self-defense.
              </p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                {[
                  { name: 'Striking', desc: 'Punches & kicks — sharp and powerful' },
                  { name: 'Kickboxing', desc: 'Cardio & combat conditioning' },
                  { name: 'Takedowns', desc: 'Wrestling & combat grappling' },
                ].map(d => (
                  <div key={d.name} style={{
                    display: 'flex', alignItems: 'center', gap: '14px',
                    padding: '14px 16px',
                    background: 'rgba(231,76,60,0.05)',
                    border: '1px solid rgba(231,76,60,0.12)', borderRadius: '10px',
                  }}>
                    <div style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#E74C3C', flexShrink: 0 }} />
                    <div>
                      <div style={{ fontSize: '14px', fontWeight: 700, color: '#fff', fontFamily: 'Arial, sans-serif' }}>{d.name}</div>
                      <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.4)', fontFamily: 'Arial, sans-serif' }}>{d.desc}</div>
                    </div>
            ...
            <div className="class-card" style={{
              ...
              <div style={{ fontSize: '44px', marginBottom: '20px', lineHeight: 1 }}>⚡</div>
              <div style={{ fontSize: '11px', fontWeight: 700, letterSpacing: '0.2em', color: '#63B3ED', fontFamily: 'Arial, sans-serif', marginBottom: '10px' }}>FITNESS & WELLNESS</div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                {[
                  ...
                  <div key={d.name} style={{
                    ...
                    border: '1px solid rgba(99,179,237,0.12)', borderRadius: '10px',
                  }}>
                    <div style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#63B3ED', flexShrink: 0 }} />
                    <div>
                      <div style={{ fontSize: '14px', fontWeight: 700, color: '#fff', fontFamily: 'Arial, sans-serif' }}>{d.name}</div>
                      <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.4)', fontFamily: 'Arial, sans-serif' }}>{d.desc}</div>
                    </div>
